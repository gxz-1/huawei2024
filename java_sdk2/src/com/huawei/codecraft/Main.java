...
public class Main {
    ...
    private BFSPathSearch.berthInfo[][] ch2berth=new BFSPathSearch.berthInfo[210][210];
    /**
...
//                BestPath = AStar.findPath(x, y, BestGood.x, BestGood.y,blockArray);
        ...
        public void searchBerth3(){//BFS找最近的泊位
            ...
            if (berthInfo.berth_id != -1) {
                mvPath= AStar.findPath(x, y, berth[berthInfo.berth_id].x, berth[berthInfo.berth_id].y,blockArray);
            }
        }
